            ...
            child: BottomNavigationBar(
                ...
                items: [
                  BottomNavigationBarItem(
                      icon:
                          buildMyIcon(index: 0, imageName: AppAssets.quranIcon),
                      label: "Quran"),
                  BottomNavigationBarItem(
                      icon: buildMyIcon(
                          index: 1, imageName: AppAssets.hadethIcon),
                      label: "Hadeth"),
                  BottomNavigationBarItem(
                      icon:
                          buildMyIcon(index: 2, imageName: AppAssets.sebhaIcon),
                      label: "Sebha"),
                  BottomNavigationBarItem(
                      icon:
                          buildMyIcon(index: 3, imageName: AppAssets.radioIcon),
                      label: "Radio"),
                  BottomNavigationBarItem(
                      icon:
                          buildMyIcon(index: 4, imageName: AppAssets.timeIcon),
                      label: "Time"),
                ]),
          ),
        )
    ...
    return activeIndex == index
        ? Container(
            padding: EdgeInsets.symmetric(
                vertical: 0.006 * height, horizontal: 0.046 * width),
